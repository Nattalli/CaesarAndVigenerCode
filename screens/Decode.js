    ...
    return (
        <View style={styles.container}>
            <View style={styles.tasksWrapper}>
                <Text style={styles.sectionTitle}>Дешифрувати текст</Text>
                ...
                <Pressable
                    ...
                    onPress={() => navigation.navigate(getNextPageNameCaesar())}>
                ...
                <Pressable
                    style={styles.buttonStyle}
                    onPress={() => navigation.navigate(getNextPageNameVigener())}>
                    <Text style={styles.buttonText}>
                        Шифр Віженера
                    </Text>
                </Pressable>
